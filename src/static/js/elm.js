...
var _valrus$undertale_dialog$DialogBox$fontFaceStyle = function (_p2) {
	var _p3 = _p2;
	return A2(
		_elm_lang$core$String$join,
		'\n',
...
var _valrus$undertale_dialog$DialogBox$singleBox = F3(
	function (x, y, model) {
		...
		var _p4 = _valrus$undertale_dialog$Character$portraitSize(model.chara);
		var sizeX = _p4._0;
		var sizeY = _p4._1;
		var _p5 = _valrus$undertale_dialog$Character$portraitOffset(model.chara);
		var imgX = _p5._0;
		var imgY = _p5._1;
		return {
			ctor: '::',
...
var _valrus$undertale_dialog$DialogBox$view = function (model) {
	var _p8 = _valrus$undertale_dialog$DialogBox$certifyModel(model);
	if (_p8.ctor === 'Nothing') {
		return A2(
			_elm_lang$html$Html$div,
			{
		...
		return A2(
			...
			_valrus$undertale_dialog$DialogBox$dialogFrame(_p9),
			_p9);
	}
};
...
var _valrus$undertale_dialog$DialogBoxes$renderTexts = F2(
	function (i, box) {
		var _p3 = _valrus$undertale_dialog$DialogBox$certifyModel(box);
		if (_p3.ctor === 'Nothing') {
			return A2(
				_elm_lang$svg$Svg$g,
				{ctor: '[]'},
...
var _valrus$undertale_dialog$DialogBoxes$init = {boxes: _valrus$undertale_dialog$DialogBoxes$initBoxes, focusIndex: 0, renderId: _elm_lang$core$Maybe$Nothing};
		...
		switch (_p14.ctor) {
			...
			case 'SetImage':
				...
				if (_p15.ctor === 'Nothing') {
					...
					return A2(_valrus$undertale_dialog$DialogBoxes$SetImages, _p14._0, _p15._0);
				}
			case 'SetText':
				return A2(_valrus$undertale_dialog$DialogBoxes$UpdateText, boxNum, _p14._0);
			default:
				return A2(_valrus$undertale_dialog$DialogBoxes$ExpectImage, boxNum, _p14._0);
		}
	});
...
var _valrus$undertale_dialog$DialogBoxes$renderBox = F2(
	function (i, box) {
		var _p16 = _valrus$undertale_dialog$DialogBox$certifyModel(box);
		if (_p16.ctor === 'Nothing') {
			return A2(
				_elm_lang$svg$Svg$g,
				{ctor: '[]'},
...
var _valrus$undertale_dialog$DialogBoxes$view = function (model) {
	var _p18 = model.renderId;
	if (_p18.ctor === 'Just') {
		return {
			ctor: '::',
			_0: _valrus$undertale_dialog$DialogBoxes$centerWrapper(
				A2(_valrus$undertale_dialog$DialogBoxes$renderBoxes, model.boxes, _p18._0)),
			_1: {ctor: '[]'}
		};
	} else {
...
var _valrus$undertale_dialog$UndertaleDialog$defaultSprite = F3(
	function (root, c, thumbnail) {
		return A3(
			_valrus$undertale_dialog$UndertaleDialog$spriteNumber,
			root,
			c,
			thumbnail ? 0 : 1);
	});
				...
				_toastal$either$Either$Right(
					_valrus$undertale_dialog$UndertaleDialog$UpdateDialogs(
						A2(
							...
							A3(_valrus$undertale_dialog$UndertaleDialog$defaultSprite, root, _valrus$undertale_dialog$Character$Temmie, false))))),
			_1: {ctor: '[]'}
		});
};
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_valrus$undertale_dialog$UndertaleDialog$UpdateDialogs(
							A2(
								_valrus$undertale_dialog$DialogBoxes$SetImages,
								c,
								A3(_valrus$undertale_dialog$UndertaleDialog$defaultSprite, staticRoot, c, false)))),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(_valrus$undertale_dialog$UndertaleDialog$flatButton),
						_1: {ctor: '[]'}
					...
					_0: A2(
						_elm_lang$html$Html$img,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$src(
									A3(_valrus$undertale_dialog$UndertaleDialog$defaultSprite, staticRoot, c, true)),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
