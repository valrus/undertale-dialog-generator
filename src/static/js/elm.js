...
var _valrus$undertale_dialog$Character$dialogAsterisk = function (c) {
	var _p0 = c;
	if (_p0.ctor === 'Papyrus') {
		return '';
	} else {
...
var _valrus$undertale_dialog$Character$textboxStyles = function (c) {
	var _p1 = c;
	switch (_p1.ctor) {
		case 'Papyrus':
			return {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'width', _1: '416px'},
				_1: {
					ctor: '::',
		...
		case 'Sans':
			return {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'width', _1: '382px'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'left', _1: '184px'},
					_1: {ctor: '[]'}
				}
			};
		default:
...
var _valrus$undertale_dialog$Character$fontStyles = function (c) {
	...
	switch (_p2.ctor) {
		case 'Papyrus':
			return {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'font-family', _1: 'Smooth_Papyrus, Papyrus'},
				_1: {
					ctor: '::',
		...
		case 'Sans':
			return {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'font-family', _1: 'Comic Sans, Comic Sans MS Regular, Comic Sans MS'},
				_1: {
					ctor: '::',
...
var _valrus$undertale_dialog$DialogBox$certifyModel = function (model) {
	var _p1 = A4(
	...
	if (_p1.ctor === 'Nothing') {
		...
		return _elm_lang$core$Maybe$Just(
			{chara: _p1._0._0, imgSrc: _p1._0._1, text: _p1._0._2, index: model.index, expectingImage: model.expectingImage});
	}
};
	...
	return A2(
		...
		},
		{
			...
			_0: _elm_lang$html$Html$text(
				_valrus$undertale_dialog$Character$dialogAsterisk(character)),
			_1: {ctor: '[]'}
		});
};
var _valrus$undertale_dialog$DialogBox$init = F2(
	function (s, i) {
		return {chara: _elm_lang$core$Maybe$Nothing, imgSrc: _elm_lang$core$Maybe$Nothing, text: s, index: i, expectingImage: false};
	});
var _valrus$undertale_dialog$DialogBox$Model = F5(
	function (a, b, c, d, e) {
...
var _valrus$undertale_dialog$DialogBox$portraitButton = F4(
	function (pos, src, chara, alpha) {
		return A2(
					...
					_1: {
						...
						_1: {
							...
							_0: _elm_lang$svg$Svg_Events$onClick(
								_valrus$undertale_dialog$DialogBox$ExpectImage(true)),
							_1: {ctor: '[]'}
						}
					}
				},
...
var _valrus$undertale_dialog$DialogBox$dialogFrame = function (model) {
	var portraitAlpha = model.expectingImage ? 0.5 : 1;
	var _p2 = _valrus$undertale_dialog$Character$portraitSize(model.chara);
	var sizeX = _p2._0;
	var sizeY = _p2._1;
	var _p3 = _valrus$undertale_dialog$Character$portraitOffset(model.chara);
	var imgX = _p3._0;
	var imgY = _p3._1;
	return A2(
		_elm_lang$svg$Svg$svg,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$width(
				_elm_lang$core$Basics$toString(596)),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$height(
					_elm_lang$core$Basics$toString(168)),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				A4(_valrus$undertale_dialog$Helpers$Position, 0, 0, 596, 168),
				'black'),
			_1: {
				ctor: '::',
				_0: A2(
				...
				_1: {
					...
					_1: {
						...
						_0: A4(
							...
							A4(_valrus$undertale_dialog$Helpers$Position, ((298 - 214) + imgX) - sizeX, (84 + imgY) - sizeY, imgX * 2, imgY * 2),
							model.imgSrc,
							model.chara,
							portraitAlpha),
						_1: {ctor: '[]'}
						...
						_0: _elm_lang$html$Html_Attributes$style(
							A2(
								...
								A2(
									...
									_valrus$undertale_dialog$Character$textboxStyles(model.chara)))),
						_1: {
							ctor: '::',
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'width', _1: '596px'},
								_1: {
									ctor: '::',
...
var _valrus$undertale_dialog$DialogBox$view = function (model) {
	var _p6 = _valrus$undertale_dialog$DialogBox$certifyModel(model);
	if (_p6.ctor === 'Nothing') {
		return A2(
			_elm_lang$html$Html$div,
			{
		...
		return A2(
			...
			_valrus$undertale_dialog$DialogBox$dialogFrame(_p7),
			_p7);
	}
};
...
var _valrus$undertale_dialog$DialogBoxes$viewable = function (model) {
	return A2(
		...
		_elm_lang$core$Array$toList(
			A2(_elm_lang$core$Array$map, _valrus$undertale_dialog$DialogBox$certifyModel, model.boxes)));
};
...
var _valrus$undertale_dialog$DialogBoxes$count = function (model) {
...
var _valrus$undertale_dialog$DialogBoxes$update = F2(
	function (action, model) {
		...
		switch (_p4.ctor) {
						...
						model,
						{
							boxes: A2(
								...
								A3(
									...
									_p4._0,
									_elm_lang$core$Maybe$Just(_p4._1),
									_elm_lang$core$Native_Utils.eq(
										_valrus$undertale_dialog$DialogBoxes$count(model),
										1)),
								model.boxes)
						}),
					_1: false
								...
								A2(
									...
									function (_p6) {
										...
										return A2(
											...
											_valrus$undertale_dialog$DialogBox$SetText(_p7._0),
											_p7._1);
									},
									A3(
										_elm_lang$core$List$map2,
			...
			default:
				var _p9 = _p4._0;
				var box = A2(_elm_lang$core$Array$get, _p9, model.boxes);
				var _p8 = box;
				if (_p8.ctor === 'Nothing') {
					return {ctor: '_Tuple2', _0: model, _1: false};
				} else {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								boxes: A3(
									...
									A2(
										_valrus$undertale_dialog$DialogBox$update,
										_valrus$undertale_dialog$DialogBox$ExpectImage(_p4._1),
										_p8._0),
									model.boxes)
							}),
						_1: false
...
var _valrus$undertale_dialog$DialogBoxes$initBoxes = _elm_lang$core$Array$fromList(
	{
		ctor: '::',
		_0: A2(
			_valrus$undertale_dialog$DialogBox$init,
			_elm_lang$core$Maybe$Just(''),
			1),
		_1: {
			ctor: '::',
			_0: A2(_valrus$undertale_dialog$DialogBox$init, _elm_lang$core$Maybe$Nothing, 2),
			_1: {
				ctor: '::',
				_0: A2(_valrus$undertale_dialog$DialogBox$init, _elm_lang$core$Maybe$Nothing, 3),
				_1: {ctor: '[]'}
			}
		}
	});
var _valrus$undertale_dialog$DialogBoxes$init = {boxes: _valrus$undertale_dialog$DialogBoxes$initBoxes, focusIndex: 0};
var _valrus$undertale_dialog$DialogBoxes$resetTexts = function (boxes) {
	var boxList = _elm_lang$core$Array$toList(boxes);
	var _p10 = {
		ctor: '_Tuple2',
		_0: _elm_lang$core$List$head(boxList),
		_1: _elm_lang$core$List$tail(boxList)
	};
	var first = _p10._0;
	var rest = _p10._1;
	var _p11 = A3(
	...
	if (_p11.ctor === 'Nothing') {
		...
		return _valrus$undertale_dialog$DialogBoxes$initBoxes;
	}
};
var _valrus$undertale_dialog$DialogBoxes$Model = F2(
	function (a, b) {
		return {boxes: a, focusIndex: b};
	});
...
var _valrus$undertale_dialog$DialogBoxes$NoOp = {ctor: 'NoOp'};
var _valrus$undertale_dialog$DialogBoxes$convertViewMessage = F2(
	function (boxNum, boxMsg) {
		var _p12 = boxMsg;
		switch (_p12.ctor) {
			case 'NoOp':
				return _valrus$undertale_dialog$DialogBoxes$NoOp;
			case 'SetImage':
				var _p13 = _p12._1;
				if (_p13.ctor === 'Nothing') {
					return _valrus$undertale_dialog$DialogBoxes$NoOp;
...
var _valrus$undertale_dialog$DialogBoxes$view = function (model) {
	return _elm_lang$core$Array$toList(
		A2(_elm_lang$core$Array$indexedMap, _valrus$undertale_dialog$DialogBoxes$mapBoxView, model.boxes));
};
...
var _valrus$undertale_dialog$UndertaleDialog$spriteFolder = F2(
	function (root, c) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			root,
...
var _valrus$undertale_dialog$UndertaleDialog$spriteNumber = F3(
	function (root, c, n) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_valrus$undertale_dialog$UndertaleDialog$spriteFolder, root, c),
			A2(
				_elm_lang$core$Basics_ops['++'],
				'/',
				A2(
...
var _valrus$undertale_dialog$UndertaleDialog$defaultSprite = F2(
	function (root, c) {
		return A3(_valrus$undertale_dialog$UndertaleDialog$spriteNumber, root, c, 0);
	});
	...
	function (characters, flags) {
		return {
			...
			_0: {
				...
				dialogs: _valrus$undertale_dialog$DialogBoxes$init,
...
var _valrus$undertale_dialog$UndertaleDialog$getDialogBoxImg = function (model) {
	...
	if (_p4.ctor === 'Nothing') {
		...
		return A2(
			_elm_lang$http$Http$send,
			_valrus$undertale_dialog$UndertaleDialog$GotDownload,
			_elm_lang$http$Http$getString(
				A2(
					_valrus$undertale_dialog$Helpers$makeUrl,
					_valrus$undertale_dialog$UndertaleDialog$getSubmitUrl(model.scriptRoot),
					A2(
						_elm_lang$core$Basics_ops['++'],
						{
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'text',
								_1: _valrus$undertale_dialog$DialogBoxes$concat(model.dialogs)
							},
							_1: {ctor: '[]'}
						},
						A2(
							...
							_valrus$undertale_dialog$DialogBoxes$getImgSrcs(model.dialogs))))));
	}
};
	...
	function (msg, model) {
		...
		switch (_p5.ctor) {
			case 'NoOp':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'EnterCheatCode':
				var _p6 = A2(_valrus$undertale_dialog$CheatCode$update, _p5._0, model.cheatCode);
				var newCheatCode = _p6._0;
				var cheatResult = _p6._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'UpdateDialogs':
				var _p9 = _p5._0;
				var _p7 = A2(_valrus$undertale_dialog$DialogBoxes$update, _p9, model.dialogs);
				var newBoxes = _p7._0;
			...
			case 'SetScriptRoot':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{scriptRoot: _p10}),
					_1: _valrus$undertale_dialog$UndertaleDialog$getImgurParams(_p10)
				};
			case 'SetStaticRoot':
				return {
					ctor: '_Tuple2',
			...
			case 'GetDownload':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _valrus$undertale_dialog$UndertaleDialog$getDialogBoxImg(model)
				};
			case 'GotDownload':
				if (_p5._0.ctor === 'Ok') {
					var _p12 = _p5._0._0;
			...
			case 'UpdateModal':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							modal: A2(_valrus$undertale_dialog$Modal$update, _p5._0, model.modal)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				var _p13 = A2(_valrus$undertale_dialog$Imgur$update, _p5._0, model.imgur);
				...
				_toastal$either$Either$Right(
					_valrus$undertale_dialog$UndertaleDialog$UpdateDialogs(
						A2(
							...
							A2(_valrus$undertale_dialog$UndertaleDialog$defaultSprite, root, _valrus$undertale_dialog$Character$Temmie))))),
			_1: {ctor: '[]'}
		});
};
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_valrus$undertale_dialog$UndertaleDialog$UpdateDialogs(
							A2(
								_valrus$undertale_dialog$DialogBoxes$SetImages,
								c,
								A2(_valrus$undertale_dialog$UndertaleDialog$defaultSprite, staticRoot, c)))),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(_valrus$undertale_dialog$UndertaleDialog$flatButton),
						_1: {ctor: '[]'}
...
var _valrus$undertale_dialog$UndertaleDialog$moodButton = F3(
	function (root, c, n) {
		var spriteStr = A3(_valrus$undertale_dialog$UndertaleDialog$spriteNumber, root, c, n);
		return A2(
			_elm_lang$html$Html$button,
			{
				ctor: '::',
...
var _valrus$undertale_dialog$UndertaleDialog$dialogBoxImg = F2(
	function (boxes, pngData) {
		var boxCount = _valrus$undertale_dialog$DialogBoxes$count(boxes);
		return {
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$a,
	...
	function (boxes, imgData) {
		return A2(
			...
			A3(
				...
				_elm_lang$core$Maybe$Just('data:image/png;base64,'),
				imgData));
	});
...
var _valrus$undertale_dialog$UndertaleDialog$subs = function (model) {
	return _elm_lang$keyboard$Keyboard$downs(_valrus$undertale_dialog$UndertaleDialog$EnterCheatCode);
};
var _valrus$undertale_dialog$UndertaleDialog$main = _elm_lang$html$Html$programWithFlags(
	{
		init: _valrus$undertale_dialog$UndertaleDialog$init(
			{
				ctor: '::',
				_0: _valrus$undertale_dialog$Character$Toriel,
				_1: {
