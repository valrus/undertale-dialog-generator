...
Elm.Helpers.make = function (_elm) {
   ...
   return _elm.Helpers.values = {_op: _op,takeJusts: takeJusts,splitEvery: splitEvery,splitLinesEvery: splitLinesEvery};
};
Elm.Imgur = Elm.Imgur || {};
...
Elm.UndertaleDialog.make = function (_elm) {
   ...
   var getDialogBoxImg = function (model) {
      ...
      if (_p0.ctor === "Nothing") {
            ...
            _U.list([{ctor: "_Tuple2",_0: "character",_1: $Basics.toString(_p0._0._0)}
                    ...
                    ,{ctor: "_Tuple2",_0: "text",_1: A2($String.join,"\n",$Helpers.takeJusts(model.text))}]))))));
         }
   };
   ...
   var dialogBoxTexts = function (arr) {
      var _p1 = $Maybe$Extra.join(A2($Array.get,0,arr));
      if (_p1.ctor === "Nothing") {
            return _U.list([""]);
         } else {
            return A2($Basics._op["++"],_U.list([_p1._0]),$Helpers.takeJusts(A3($Array.slice,1,3,arr)));
         }
   };
   var numBoxes = function (texts) {    return $List.length(dialogBoxTexts(texts));};
   var dialogBoxImg = F3(function (texts,address,pngData) {
      var boxCount = numBoxes(texts);
      return $Maybe.Just(_U.list([A2($Html.a,
      _U.list([]),
      _U.list([A2($Html.img,
      _U.list([A2($Html$Events.onClick,address,A3(UpdateText,numBoxes(texts),A2($Maybe.withDefault,"",$Maybe$Extra.join(A2($Array.get,boxCount,texts))),true))
   ...
   var returnedDialogBox = F3(function (texts,address,imgData) {
   ...
   var updateText = F4(function (lastBoxCount,entryBoxNum,newBoxText,oldTextArray) {
      var newText = $Array.fromList(A3($Helpers.splitLinesEvery,3,3,textsToString(A3($Array.set,entryBoxNum,$Maybe.Just(newBoxText),oldTextArray))));
      return {ctor: "_Tuple2",_0: $List.length(dialogBoxTexts(newText)),_1: newText};
   });
   var update = F2(function (action,model) {
      var _p2 = action;
      switch (_p2.ctor)
      {case "NoOp": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         ...
         case "UpdateText": var _p3 = A4(updateText,model.lastBoxCount,_p2._0,_p2._1,model.text);
           var boxCount = _p3._0;
           var newText = _p3._1;
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,{text: newText,imageData: $Maybe.Nothing,lastBoxCount: boxCount})
   ...
   var doubleImage = F2(function (imgSrc,_p8) {    var _p9 = _p8;return A3($Graphics$Element.image,_p9._0 * 2,_p9._1 * 2,imgSrc);});
   ...
   var dialogFrame = F2(function (imgSrc,character) {
      var _p10 = $Character.portraitOffset($Maybe.Just(character));
      var imgX = _p10._0;
      var imgY = _p10._1;
      ...
      _U.list([A2($Graphics$Collage.filled,$Color.grayscale(1),A2($Graphics$Collage.rect,596,168))
              ...
              $Graphics$Collage.toForm(A2(doubleImage,imgSrc,$Character.portraitSize($Maybe.Just(character)))))])));
   });
   ...
   var dialogCollage = F5(function (e,address,character,num,text) {
      return A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: "100%"}]))]),
      _U.list([A2($Html.div,
   ...
   var dialogBoxes = F2(function (address,model) {
      var _p11 = A3($Maybe.map2,F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),model.selection,model.moodImg);
      if (_p11.ctor === "Nothing") {
            return $Maybe.Nothing;
         } else {
            return $Maybe$Extra.combine(A2($List.indexedMap,A3(dialogBox,address,_p11._0._0,_p11._0._1),dialogBoxTexts(model.text)));
         }
   });
   ...
   var dialogBoxSection = F2(function (address,model) {
      ...
      $Maybe.oneOf(_U.list([A3($Maybe.map2,
                           ...
                           ,A3($Maybe.map2,
                           F2(function (x,y) {    return A2($Basics._op["++"],x,y);}),
                           A2(dialogBoxes,address,model),
                           $Maybe.Just(crunchyButton(address)))]))));
   });
   ...
   var init = F2(function (characters,focusAddress) {
      return {characters: characters
             ...
             ,moodImg: $Maybe.Nothing
             ,text: $Array.fromList(_U.list([$Maybe.Just(""),$Maybe.Nothing,$Maybe.Nothing]))
             ,staticRoot: "/static/"
             ,scriptRoot: ""
             ,imageData: $Maybe.Nothing
